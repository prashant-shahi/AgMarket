			...
			<div class="row">
				<div class="col-sm-10 col-md-8 col-lg-4 m-l-r-auto">
					...
					<div class="block1 hov-img-zoom pos-relative m-b-30">
						...
						<div class="block1-wrapbtn w-size2">
							<!-- Button -->
							<a href="machineries.html" class="flex-c-m size2 m-text2 bg3 hov1 trans-0-4">
								Machineries
							</a>
						</div>
					</div>
					...
					<div class="block1 hov-img-zoom pos-relative m-b-30">
						...
						<div class="block1-wrapbtn w-size2">
							<!-- Button -->
							<a href="cattles.html" class="flex-c-m size2 m-text2 bg3 hov1 trans-0-4">
								Cattles
							</a>
						</div>
					</div>
				...
				<div class="col-sm-10 col-md-8 col-lg-4 m-l-r-auto">
					...
					<div class="block1 hov-img-zoom pos-relative m-b-30">
						...
						<div class="block1-wrapbtn w-size2">
							<!-- Button -->
							<a href="seeds.html" class="flex-c-m size2 m-text2 bg3 hov1 trans-0-4">
								Seeds
							</a>
						</div>
					</div>
					...
					<div class="block1 hov-img-zoom pos-relative m-b-30">
						...
						<div class="block1-wrapbtn w-size2">
							<!-- Button -->
							<a href="crops.html" class="flex-c-m size2 m-text2 bg3 hov1 trans-0-4">
								Crops
							</a>
						</div>
					</div>
