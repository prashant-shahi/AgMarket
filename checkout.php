			...
			<h2 class="center">Sack is empty ! <br/><a href="index.php" alt="AgMarket Home Page" style="text-decoration: none;">Browse and Add commodities in the sack !!</a><        /h2>
				...
				<div class="container-table-cart pos-relative">
					<div class="wrap-table-shopping-cart bgwhite">
						...
						<div class="container">
							<div class="row">
								<div class="col-xs-6 col-sm-6 col-md-6"><strong>Total Cost</strong></div>
								<div class="col-xs-6 col-sm-6 col-md-6 text-right"><strong>₹ <?php echo $gtotal; ?></strong></div>

								<div class="col-xs-6 col-sm-6 col-md-6">
									<div class="size10 trans-0-4 m-t-10 m-b-10">
										<a class="flex-c-m sizefull bg1 bo-rad-23 hov1 s-text1 trans-0-4" href="updateCart.php">Update Cart</a>
									</div>
								</div>
							</div>
							<div class="row">
								<div class="flex-w flex-sb-m p-t-25 p-b-25 p-l-35 p-r-60 p-lr-15-sm">
									<div class="size10 trans-0-4 m-t-10 m-b-10">
										<a class="flex-c-m sizefull bg1 bo-rad-23 hov1 s-text1 trans-0-4" href="checkout.php">Checkout</a>
									</div>
								</div>
							</div>
						</div>
