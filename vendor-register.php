...
<section class="bg9 p-b-30">
	<div class="container">
		<h3 class="bg6 text-center p-t-15 p-b-15">Register New Vendor</h3>
		<div class="row">
			...
			<form class="bgwhite p-b-20 p-l-20 p-t-20 col-xs-12 col-sm-12 col-md-8 col-lg-8" method="post" action="" autocomplete="off">
				...
				<div class="w-size2">
					<button type="submit" name="reg_vendor" class="flex-c-m size2 bg4 bo-rad-23 hov1 m-text3 trans-0-4">
						Register
					</button>
				</div>
				<p>
