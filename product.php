		...
		<div class="container">
			<div class="row">
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-30">
					<div class="search-product pos-relative bo4 of-hidden m-b-30">
					...
					<div class="leftbar p-r-20 p-r-0-sm">
						...
						<ul class="p-b-54">
							...
							<li class="p-t-4">
								<a href="cattles.php" class="s-text13">
									Cattles
								</a>
							</li>

							<li class="p-t-4">
								<a href="crops.php" class="s-text13">
									Crops
								</a>
							</li>

							<li class="p-t-4">
								<a href="machineries.php" class="s-text13">
									Machineries
								</a>
							</li>

							<li class="p-t-4">
								<a href="seeds.php" class="s-text13">
									Seeds
								</a>
							</li>
						</ul>
